# -*- perl -*-
# t/103-rcopy.t - tests of rcopy() method
use strict;
use warnings;
...
SKIP: {
    no warnings 'once';
    skip "File::Copy::Recursive does not yet test for system's capacity to support hard links", 3
        unless $File::Copy::Recursive::Link;
    use warnings;
...
SKIP: {
    skip "System does not support symlinks", 11
        unless $File::Copy::Recursive::CopyLink;
    ...
    ok($rv, "fcopy() returned true value when copying from symlink");
    TODO: {
        local $TODO = "Not sure why warning is not being generated";
...
{
    note("Basic tests of File::Copy::Recursive::rcopy()");
